...
//        guard let root = self.navigationController.viewControllers.first as? CommonViewController,
...
//    
//    func moveToPoseFeed() {
//        guard let rootVC = self.navigationController.viewControllers.first as? CommonViewController else {
//            return
//        }
